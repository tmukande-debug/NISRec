...
try:
    ...
    valid_neighbor_matrix = Neighbor_Op(user_train_valid, usernum, args.maxlen, Item, n_hots, "valid")
...
try:
    ...
    test_neighbor_matrix = Neighbor_Op(user_train_test, usernum, args.maxlen, Item, n_hots, "test")
